'''Terminologies-----
    ...
    GENERATOR BREAK, means the last break time while generating the pattern above in segments.
    1 sample takes 'inverse of the audio sampling frequency' seconds to play, usually 1/44100 seconds
...
class WavProcessor:
    ...
    def reverb(self):
        ...
        ''' 
        Reverb delay reduced in right speaker to form some sort of exponential 
        reverb within the 2200/44100 secs time frame
        '''
